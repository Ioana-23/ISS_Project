...
import project.domain.CreditProperties;
...
public class ConfirmChoicesController {
    @FXML
    ...
    public ConfirmChoicesController() {}
    ...
    private void handleReservation()
    {
        ...
        StringBuilder nrTelefon = new StringBuilder();
        for(int i = 0; i < reservation.getUser().getNumarTelefon().size(); i++)
        {
            nrTelefon.append(reservation.getUser().getNumarTelefon().get(i));
        }
    ...
    {
        service.addReservation(reservation.getMovieScreening(), Status.Inregistrata, reservation.getSeatsReserved(), reservation.getUser());
        ((Node)(actionEvent.getSource())).getScene().getWindow().hide();
    ...
    public void handleBuy() {
        ...
        buttonConfirm.setOnAction(new EventHandler<>() {
            ...
            private void handleSendReservation1(ActionEvent actionEvent) {
                service.addReservation(reservation.getMovieScreening(), Status.Confirmata, reservation.getSeatsReserved(), reservation.getUser());
                ((Node) (actionEvent.getSource())).getScene().getWindow().hide();
                mainPageController.refreshData();
            }
