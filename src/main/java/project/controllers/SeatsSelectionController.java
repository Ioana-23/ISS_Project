...
public class SeatsSelectionController {
    @FXML
    ...
    private final List<Seat> seatsSelected = new ArrayList<>();
    private List<Properties> properties;
    private final List<List<Button>> configuration = new ArrayList<>();
    private MainPageController mainPageController;
    private int nrLocuri = 0;

    public SeatsSelectionController() {}
    ...
    private void handleContinueReserve(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/views/confirm-choices.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 523, 325);
        Stage stage = new Stage();
        stage.setScene(scene);
        stage.show();
        ConfirmChoicesController appController = fxmlLoader.getController();
